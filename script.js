...
function foo(event){
    ...
    // To create Rows to add the data from the form to table.
    ...
    cell5.innerHTML = pin;
    cell6.innerHTML = gen;
    cell7.innerHTML = foodz.join(', '); // Join food choices into a string
...
para.id="description"
para.innerHTML="A simple form to get the user input and display it on the table when clicking on the button submit"
...
function tab_class(tagname,classname,idname)
{
...
var tab=tab_class("table","table","myTable")
...
var th5=tableheader("th","scope","col","Pin")
var th6=tableheader("th","scope","col","Gender")
var th7=tableheader("th","scope","col","Choice of Food")
var th8=tableheader("th","scope","col","State")
var th9=tableheader("th","scope","col","Country")
